...
DATASET_DIR = Path(
    "/path/to/data/light_cabbage_training_dataset"
)
...
PRESETS = {
    ...
    "revision_experiments": {
        "FAST_MODE": False,
        "JOINT_METHODS_TO_RUN": ["bicubic", "srcnn", "edsr", "rcan", "swinir", "esrgan", "hat", "dat", "edsr_wide"],
        "BANDWISE_METHODS_TO_RUN": ["bicubic", "edsr", "rcan", "swinir", "esrgan", "hat", "dat"],
        "RUN_JOINT_5CH": True,
        "RUN_BANDWISE_ABLATION": True,
        "EPOCHS": 50,
        "PATCHES_PER_EPOCH": 1000,
...
elif EXPERIMENT_PRESET == "noise_hat":
    EVAL_NOISE_SIGMAS = [0.0, 0.01, 0.03]
else:
    EVAL_NOISE_SIGMAS = [0.0]
EVAL_NOISE_METHODS = ["hat"] if EXPERIMENT_PRESET == "noise_hat" else ["edsr", "rcan", "esrgan"]
EVAL_NOISE_SCALES = [4]
...
if EXPERIMENT_PRESET == "revision_experiments":
    ...
    LOSS_ABLATION_PROFILE_IDS = ["l1", "l1_sam", "l1_sam_vi"]
elif EXPERIMENT_PRESET in ("degradation_b2", "esrgan_retrain", "hat_bandwise_retrain", "noise_hat"):
